			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectap-display": {
								"semanticObject": "projectap",
								"action": "display",
								"description": "A Fiori App AP.",
								"title": "App AP",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=project.ap",
									"url": sap.ui.require.toUrl("project/ap")
								}
							}
						}
					}
